...
public class CustomPO {
    ...
    private Integer commIntervalId;
    ...
    public Integer getCommIntervalId() {
        return commIntervalId;
    }

    public void setCommIntervalId(Integer commIntervalId) {
        this.commIntervalId = commIntervalId;
    }
