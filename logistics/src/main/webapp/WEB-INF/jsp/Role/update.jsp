...
<body>
	<form action="${pageContext.request.contextPath }/role/update" method="post" class="definewidth m20">
		<input type="hidden" name="roleId" value="${rolePO.roleId }">
		<table class="table table-bordered table-hover definewidth m10">
			<tr>
				<td width="10%" class="tableleft">角色名称</td>
				<td><input type="text" name="roleName" value="${rolePO.roleName }"/></td>
			</tr>
			
			<tr>
				<td width="10%" class="tableleft">角色描述</td>
				<td><input type="text" name="roleDesc" value="${rolePO.roleDesc }"/></td>
			</tr>
			<tr>
